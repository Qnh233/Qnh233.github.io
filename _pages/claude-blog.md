...
### 3. Steering Claude Code: CLAUDE.md files, skills, hooks, rules, subagents and more
- **日期**：2026-06-18
- **分类**：Claude Code
...
### 4. Centrally manage authorization for MCP connectors
- **日期**：2026-06-18
...
### 5. Claude Code now supports artifacts
- **日期**：2026-06-18
...
### 6. Meet the winners of our Claude Opus 4.8 Build Day hackathon
- **日期**：2026-06-17
- **分类**：Claude Code
...
### 7. Claude Design now stays on brand for daily work
- **日期**：2026-06-17
- **分类**：Product announcements
...
### 8. Secure access to the Claude Platform with Workload Identity Federation
- **日期**：2026-06-17
- **分类**：Product announcements
...
### 9. Meet the winners of the Built with Opus 4.7 Claude Code hackathon
- **日期**：2026-06-15
- **分类**：Claude Code
...
### 10. The evolution of agentic surfaces: building with Claude Managed Agents
- **日期**：2026-06-10
- **分类**：Agents
...
### 11. New in Claude Managed Agents: run agents on a schedule and store environment variables in vaults
- **日期**：2026-06-09
- **分类**：Product announcements
...
### 12. Building intelligent apps for Apple platforms with Claude in the Foundation Models framework
- **日期**：2026-06-08
- **分类**：Product
...
### 13. Observability for developers building connectors
- **日期**：2026-06-08
- **分类**：Product
...
### 14. How one Anthropic seller rebuilt his team's workflows with Claude Code
- **日期**：2026-06-05
...
### 15. The Claude Cowork product guide
- **日期**：2026-06-05
- **分类**：Enterprise AI
...
### 16. Best practices for getting started with Claude Cowork
- **日期**：2026-06-03
- **分类**：Enterprise AI
...
### 17. Running an AI-native engineering org
- **日期**：2026-06-03
- **分类**：Claude Code
...
### 18. Lessons from building Claude Code: How we use skills
- **日期**：2026-06-03
- **分类**：Claude Code
...
### 19. How Anthropic enables self-service data analytics with Claude
- **日期**：2026-06-03
- **分类**：Enterprise AI
...
### 20. A harness for every task: dynamic workflows in Claude Code
- **日期**：2026-06-02
- **分类**：Claude Code
...
### 21. Introducing dynamic workflows in Claude Code
- **日期**：2026-05-28
- **分类**：Claude Code
...
### 22. Using LLMs to secure source code
- **日期**：2026-05-27
- **分类**：Security
...
### 23. How CodeRabbit used Claude to build an agent orchestration system
- **日期**：2026-05-27
- **分类**：Claude Code
...
### 25. Code w/ Claude London 2026: Rethinking how we build
- **日期**：2026-05-26
- **分类**：Product
...
### 26. How Anthropic's finance team uses Claude to shape the narrative behind the numbers
- **日期**：2026-05-22
- **分类**：Enterprise AI
...
### 27. Claude now works with more security and compliance tools
- **日期**：2026-05-21
- **分类**：Enterprise AI
...
### 28. How our partners are putting Opus to work for cybersecurity
- **日期**：2026-05-21
- **分类**：Security
...
### 29. Using Claude Code: The unreasonable effectiveness of HTML
- **日期**：2026-05-20
- **分类**：Claude Code
...
### 30. How an Anthropic sales leader uses Claude Cowork to run a 4,000-account book
- **日期**：2026-05-20
- **分类**：Enterprise AI
...
### 31. New in Claude Managed Agents: self-hosted sandboxes and MCP tunnels
- **日期**：2026-05-19
- **分类**：Product
...
### 32. Deploying Claude across the legal industry
- **日期**：2026-05-15
- **分类**：Enterprise AI
...
### 33. The founder's playbook: Building an AI-native startup
- **日期**：2026-05-14
- **分类**：Claude Code
...
### 34. How Claude Code works in large codebases: Best practices and where to start
- **日期**：2026-05-14
- **分类**：Claude Code
...
### 35. Best practices for computer and browser use with Claude
- **日期**：2026-05-13
- **分类**：Agents
...
### 36. Code w/ Claude SF 2026: Building on the AI exponential
- **日期**：2026-05-12
- **分类**：Event
...
### 37. Claude for the legal industry
- **日期**：2026-05-12
- **分类**：Product
...
### 38. How Anthropic's cybersecurity team built a threat detection platform with Claude Code
- **日期**：2026-05-12
- **分类**：Claude Code
...
### 40. Introducing the Claude Platform on AWS
- **日期**：2026-05-11
- **分类**：Product
...
### 41. Collaborate with Claude across Excel, PowerPoint, Word and Outlook
- **日期**：2026-05-07
- **分类**：Product
...
### 42. New in Claude Managed Agents: dreaming, outcomes, and multiagent orchestration
- **日期**：2026-05-06
- **分类**：Product
...
### 43. Deploying Claude across financial services
- **日期**：2026-05-05
- **分类**：Enterprise AI
...
### 44. How a non-technical project manager built and shipped a stress management app with Claude Code in six weeks
- **日期**：2026-05-01
- **分类**：Claude Code
...
### 45. Building AI agents for the enterprise
- **日期**：2026-04-30
- **分类**：Agents
...
### 46. Claude Security is now in public beta
- **日期**：2026-04-30
- **分类**：Product
...
### 47. Lessons from building Claude Code: Prompt caching is everything
- **日期**：2026-04-30
- **分类**：Claude Code
...
### 48. How Kepler built verifiable AI for financial services with Claude
- **日期**：2026-04-30
- **分类**：Enterprise AI
...
### 49. Deploying agentic AI across the enterprise with Claude Cowork
- **日期**：2026-04-29
- **分类**：Agents
...
### 50. Claude API skill now in CodeRabbit, JetBrains, Resolve AI, and Warp
- **日期**：2026-04-29
- **分类**：Agents
...
### 51. Product development in the agentic era
- **日期**：2026-04-29
- **分类**：Agents
...
### 52. Onboarding Claude Code like a new developer: Lessons from 17 years of development
- **日期**：2026-04-28
- **分类**：Claude Code
...
### 53. New connectors in Claude for everyday life
- **日期**：2026-04-23
- **分类**：Product
...
### 54. Built-in memory for Claude Managed Agents
- **日期**：2026-04-23
- **分类**：Product
...
### 55. Building agents that reach production systems with MCP
- **日期**：2026-04-22
- **分类**：Agents
...
### 56. Introducing Claude Design by Anthropic Labs
- **日期**：2026-04-17
- **分类**：Product
...
### 57. Redesigning Claude Code on desktop for parallel agents
- **日期**：2026-04-14
- **分类**：Product
...
### 58. Preparing your security program for AI-accelerated offense
- **日期**：2026-04-10
- **分类**：Security
...
### 59. Claude Managed Agents: get to production 10x faster
- **日期**：2026-04-08
- **分类**：Product
...
### 61. Harnessing Claude's intelligence
- **日期**：2026-04-02
- **分类**：Guide
...
### 62. What 81,000 people want from AI
- **日期**：2026-03-18
- **分类**：Research
- **🔗**：[原文](https://www.anthropic.com/news)
...
### 63. Claude now creates interactive charts, diagrams and visualizations
- **日期**：2026-03-12
- **分类**：Product
...
### 65. How enterprises are building AI agents in 2026
- **日期**：2025-12-09
- **分类**：Agents
...
### 66. Improving frontend design through Skills
- **日期**：2025-11-12
- **分类**：Guide
