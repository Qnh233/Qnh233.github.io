...
> 首次同步：2026-05-10 | 共 58 篇 | 每日自动更新

---

## 2026年6月

### 1. Meet the winners of Built with Opus 4.7 Claude Code hackathon
- **日期**：2026-06-15
- **分类**：Claude Code
...
### 3. New in Claude Managed Agents: run agents on a schedule and store environment variables in vaults
- **日期**：2026-06-09
...
### 4. Building intelligent apps for Apple platforms with Claude in the Foundation Models framework
- **日期**：2026-06-08
- **分类**：Product
...
### 5. Observability for developers building connectors
- **日期**：2026-06-08
- **分类**：Product
...
### 6. How one Anthropic seller rebuilt his team's workflows with Claude Code
- **日期**：2026-06-05
...
### 7. The Claude Cowork product guide
- **日期**：2026-06-05
- **分类**：Enterprise AI
...
### 8. Best practices for getting started with Claude Cowork
- **日期**：2026-06-03
- **分类**：Enterprise AI
...
### 9. Running an AI-native engineering org
- **日期**：2026-06-03
- **分类**：Claude Code
...
### 10. Lessons from building Claude Code: How we use skills
- **日期**：2026-06-03
- **分类**：Claude Code
...
### 11. How Anthropic enables self-service data analytics with Claude
- **日期**：2026-06-03
- **分类**：Enterprise AI
...
### 12. A harness for every task: dynamic workflows in Claude Code
- **日期**：2026-06-02
- **分类**：Claude Code
...
### 13. Introducing dynamic workflows in Claude Code
- **日期**：2026-05-28
- **分类**：Claude Code
...
### 14. Using LLMs to secure source code
- **日期**：2026-05-27
- **分类**：Security
...
### 15. How CodeRabbit used Claude to build an agent orchestration system
- **日期**：2026-05-27
- **分类**：Claude Code
...
### 18. How Anthropic's finance team uses Claude to shape the narrative behind the numbers
- **日期**：2026-05-22
- **分类**：Enterprise AI
...
### 19. Claude now works with more security and compliance tools
- **日期**：2026-05-21
- **分类**：Enterprise AI
...
### 20. How our partners are putting Opus to work for cybersecurity
- **日期**：2026-05-21
- **分类**：Security
...
### 22. How an Anthropic sales leader uses Claude Cowork to run a 4,000-account book
- **日期**：2026-05-20
- **分类**：Enterprise AI
...
### 23. New in Claude Managed Agents: self-hosted sandboxes and MCP tunnels
- **日期**：2026-05-19
- **分类**：Product
...
### 24. Deploying Claude across the legal industry
- **日期**：2026-05-15
- **分类**：Enterprise AI
...
### 25. The founder's playbook: Building an AI-native startup
- **日期**：2026-05-14
- **分类**：Claude Code
...
### 26. How Claude Code works in large codebases: Best practices and where to start
- **日期**：2026-05-14
- **分类**：Claude Code
...
### 27. Best practices for computer and browser use with Claude
- **日期**：2026-05-13
- **分类**：Agents
...
### 28. Code w/ Claude SF 2026: Building on the AI exponential
- **日期**：2026-05-12
- **分类**：Event
...
### 29. Claude for the legal industry
- **日期**：2026-05-12
- **分类**：Product
...
### 30. How Anthropic's cybersecurity team built a threat detection platform with Claude Code
- **日期**：2026-05-12
- **分类**：Claude Code
...
### 32. Introducing the Claude Platform on AWS
- **日期**：2026-05-11
- **分类**：Product
...
### 33. Collaborate with Claude across Excel, PowerPoint, Word and Outlook
- **日期**：2026-05-07
- **分类**：Product
...
### 34. New in Claude Managed Agents: dreaming, outcomes, and multiagent orchestration
- **日期**：2026-05-06
- **分类**：Product
...
### 35. Deploying Claude across financial services
- **日期**：2026-05-05
- **分类**：Enterprise AI
...
### 36. How a non-technical project manager built and shipped a stress management app with Claude Code in six weeks
- **日期**：2026-05-01
- **分类**：Claude Code
...
### 37. Building AI agents for the enterprise
- **日期**：2026-04-30
- **分类**：Agents
...
### 38. Claude Security is now in public beta
- **日期**：2026-04-30
- **分类**：Product
...
### 39. Lessons from building Claude Code: Prompt caching is everything
- **日期**：2026-04-30
- **分类**：Claude Code
...
### 40. How Kepler built verifiable AI for financial services with Claude
- **日期**：2026-04-30
- **分类**：Enterprise AI
...
### 41. Deploying agentic AI across the enterprise with Claude Cowork
- **日期**：2026-04-29
- **分类**：Agents
...
### 42. Claude API skill now in CodeRabbit, JetBrains, Resolve AI, and Warp
- **日期**：2026-04-29
- **分类**：Agents
...
### 43. Product development in the agentic era
- **日期**：2026-04-29
- **分类**：Agents
...
### 44. Onboarding Claude Code like a new developer: Lessons from 17 years of development
- **日期**：2026-04-28
- **分类**：Claude Code
...
### 45. New connectors in Claude for everyday life
- **日期**：2026-04-23
- **分类**：Product
...
### 46. Built-in memory for Claude Managed Agents
- **日期**：2026-04-23
- **分类**：Product
...
### 47. Building agents that reach production systems with MCP
- **日期**：2026-04-22
- **分类**：Agents
...
### 48. Introducing Claude Design by Anthropic Labs
- **日期**：2026-04-17
- **分类**：Product
...
### 49. Redesigning Claude Code on desktop for parallel agents
- **日期**：2026-04-14
- **分类**：Product
...
### 50. Preparing your security program for AI-accelerated offense
- **日期**：2026-04-10
- **分类**：Security
...
### 51. Claude Managed Agents: get to production 10x faster
- **日期**：2026-04-08
- **分类**：Product
...
### 53. Harnessing Claude's intelligence
- **日期**：2026-04-02
- **分类**：Guide
...
### 54. What 81,000 people want from AI
- **日期**：2026-03-18
- **分类**：Research
- **🔗**：[原文](https://www.anthropic.com/news)
...
### 55. Claude now creates interactive charts, diagrams and visualizations
- **日期**：2026-03-12
- **分类**：Product
...
### 57. How enterprises are building AI agents in 2026
- **日期**：2025-12-09
- **分类**：Agents
...
### 58. Improving frontend design through Skills
- **日期**：2025-11-12
- **分类**：Guide
