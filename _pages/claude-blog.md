...
> 首次同步：2026-05-10 | 共 67 篇 | 每日自动更新

---

## 2026年6月

### 1. Agent identity in Claude Tag: a new access model for autonomous, team-wide AI
- **日期**：2026-06-24
- **分类**：Claude Code
...
### 2. Building effective human-agent teams
- **日期**：2026-06-24
- **分类**：Enterprise AI / Claude Tag
- **🔗**：[原文](https://claude.com/blog/building-effective-human-agent-teams)

Anthropic 阐述人类-AI 智能体团队协作的最佳实践。从单人使用 AI 到"多人游戏"式团队协作：智能体拥有独立记忆、凭证和工具访问权，在团队频道中与人类并肩工作。四大核心经验：(1) 公开工作并给予智能体宽广上下文——默认信息公开，让智能体获取决策记录和产品规范；(2) 明确人类与智能体的角色边界——设定清晰的职责范围，人和智能体在同一线程协作；(3) 设定"北极星"目标使智能体更主动——人类制定方向，智能体据此主动建议新工作流；(4) 逐步建立信任——通过手动审查、验证器智能体、反思循环逐步授予更多自主权。基于 Claude Tag 的多玩家协作模式。

### 3. The full Claude Desktop experience on AWS, Google Cloud, and Microsoft Foundry
- **日期**：2026-06-22
- **分类**：Enterprise AI
...
### 4. Steering Claude Code: CLAUDE.md files, skills, hooks, rules, subagents and more
- **日期**：2026-06-18
- **分类**：Claude Code
...
### 5. Centrally manage authorization for MCP connectors
- **日期**：2026-06-18
...
### 6. Claude Code now supports artifacts
- **日期**：2026-06-18
...
### 7. Meet the winners of our Claude Opus 4.8 Build Day hackathon
- **日期**：2026-06-17
- **分类**：Claude Code
- **🔗**：[原文](https://claude.com/blog/meet-the-winners-of-our-claude-opus-4-8-build-day-hackathon)

Opus 4.8 线下黑客马拉松揭晓，300+ 参赛者在 12 小时内从想法到可工作 Demo。一等奖 Tekton（Holly Tang & Austin Burgess）：从史料重建唐代建筑 3D 模型，支持 339 个渐进施工状态的证据链追溯；二等奖 Sim Francisco（Tanmayi Priya Dasari & Tejas Prabhune）：基于人口普查数据构建的旧金山数字孪生城市，10,000 合成居民，选举预测误差 2.5% 以内；三等奖 Custom Universe（Jake Stevens & Mauricio Pereira）：手机拍照即可生成可编辑 3D 场景，面向机器人训练数据生成，Opus 4.8 全程操作远程 NVIDIA H100。

### 8. Claude Design now stays on brand for daily work
- **日期**：2026-06-17
- **分类**：Product announcements
- **🔗**：[原文](https://claude.com/blog/claude-design-stays-on-brand-for-daily-work)

Claude Design 重大更新：支持跨项目绑定品牌设计系统（导入 GitHub/Figma/原始组件自动校验一致性，企业版管理员锁定）、与 Claude Code 无缝衔接（/design-sync 拉取设计系统，/design 在终端直接编辑）、新增画布直接编辑和精细化布局拖拽控制。导出支持 PDF/PPT，连接器覆盖 Adobe、Canva、Gamma、Lovable、Miro、Replit、Vercel、Wix。共享用量额度，Token 效率提升，错误率大幅下降。超过 100 万用户首周即使用。

### 9. Secure access to the Claude Platform with Workload Identity Federation
- **日期**：2026-06-17
- **分类**：Product announcements
- **🔗**：[原文](https://claude.com/blog/workload-identity-federation)

Workload Identity Federation (WIF) 在 Claude Platform 正式 GA。用短期范围凭证替代静态 API Key——无需创建、轮换或担心泄露密钥。兼容任意 OIDC 身份提供商：AWS IAM、GCP/K8s Service Account、Azure Managed Identity、GitHub Actions Token、Okta 等。同时推出 Service Account，每工作负载独立身份+角色+审计追踪。Console 提供引导式设置，Admin API 支持批量编程化管理。API Key 与 WIF 可并行运行，逐步迁移。

### 10. Meet the winners of the Built with Opus 4.7 Claude Code hackathon
- **日期**：2026-06-15
- **分类**：Claude Code
...
### 11. The evolution of agentic surfaces: building with Claude Managed Agents
- **日期**：2026-06-10
- **分类**：Agents
...
### 12. New in Claude Managed Agents: run agents on a schedule and store environment variables in vaults
- **日期**：2026-06-09
- **分类**：Product announcements
...
### 13. Building intelligent apps for Apple platforms with Claude in the Foundation Models framework
- **日期**：2026-06-08
- **分类**：Product
...
### 14. Observability for developers building connectors
- **日期**：2026-06-08
- **分类**：Product
...
### 15. How one Anthropic seller rebuilt his team's workflows with Claude Code
- **日期**：2026-06-05
...
### 16. The Claude Cowork product guide
- **日期**：2026-06-05
- **分类**：Enterprise AI
...
### 17. Best practices for getting started with Claude Cowork
- **日期**：2026-06-03
- **分类**：Enterprise AI
...
### 18. Running an AI-native engineering org
- **日期**：2026-06-03
- **分类**：Claude Code
...
### 19. Lessons from building Claude Code: How we use skills
- **日期**：2026-06-03
- **分类**：Claude Code
...
### 20. How Anthropic enables self-service data analytics with Claude
- **日期**：2026-06-03
- **分类**：Enterprise AI
...
### 21. A harness for every task: dynamic workflows in Claude Code
- **日期**：2026-06-02
- **分类**：Claude Code
...
### 22. Introducing dynamic workflows in Claude Code
- **日期**：2026-05-28
- **分类**：Claude Code
...
### 24. How CodeRabbit used Claude to build an agent orchestration system
- **日期**：2026-05-27
- **分类**：Claude Code
...
### 26. Code w/ Claude London 2026: Rethinking how we build
- **日期**：2026-05-26
- **分类**：Product
...
### 27. How Anthropic's finance team uses Claude to shape the narrative behind the numbers
- **日期**：2026-05-22
- **分类**：Enterprise AI
...
### 28. Claude now works with more security and compliance tools
- **日期**：2026-05-21
- **分类**：Enterprise AI
...
### 29. How our partners are putting Opus to work for cybersecurity
- **日期**：2026-05-21
- **分类**：Security
...
### 30. Using Claude Code: The unreasonable effectiveness of HTML
- **日期**：2026-05-20
- **分类**：Claude Code
...
### 31. How an Anthropic sales leader uses Claude Cowork to run a 4,000-account book
- **日期**：2026-05-20
- **分类**：Enterprise AI
...
### 32. New in Claude Managed Agents: self-hosted sandboxes and MCP tunnels
- **日期**：2026-05-19
- **分类**：Product
...
### 33. Deploying Claude across the legal industry
- **日期**：2026-05-15
- **分类**：Enterprise AI
...
### 34. The founder's playbook: Building an AI-native startup
- **日期**：2026-05-14
- **分类**：Claude Code
...
### 35. How Claude Code works in large codebases: Best practices and where to start
- **日期**：2026-05-14
- **分类**：Claude Code
...
### 36. Best practices for computer and browser use with Claude
- **日期**：2026-05-13
- **分类**：Agents
...
### 37. Code w/ Claude SF 2026: Building on the AI exponential
- **日期**：2026-05-12
- **分类**：Event
...
### 38. Claude for the legal industry
- **日期**：2026-05-12
- **分类**：Product
...
### 39. How Anthropic's cybersecurity team built a threat detection platform with Claude Code
- **日期**：2026-05-12
- **分类**：Claude Code
...
### 41. Introducing the Claude Platform on AWS
- **日期**：2026-05-11
- **分类**：Product
...
### 42. Collaborate with Claude across Excel, PowerPoint, Word and Outlook
- **日期**：2026-05-07
- **分类**：Product
...
### 43. New in Claude Managed Agents: dreaming, outcomes, and multiagent orchestration
- **日期**：2026-05-06
- **分类**：Product
...
### 44. Deploying Claude across financial services
- **日期**：2026-05-05
- **分类**：Enterprise AI
...
### 45. How a non-technical project manager built and shipped a stress management app with Claude Code in six weeks
- **日期**：2026-05-01
- **分类**：Claude Code
...
### 46. Building AI agents for the enterprise
- **日期**：2026-04-30
- **分类**：Agents
...
### 47. Claude Security is now in public beta
- **日期**：2026-04-30
- **分类**：Product
...
### 48. Lessons from building Claude Code: Prompt caching is everything
- **日期**：2026-04-30
- **分类**：Claude Code
...
### 49. How Kepler built verifiable AI for financial services with Claude
- **日期**：2026-04-30
- **分类**：Enterprise AI
...
### 50. Deploying agentic AI across the enterprise with Claude Cowork
- **日期**：2026-04-29
- **分类**：Agents
...
### 51. Claude API skill now in CodeRabbit, JetBrains, Resolve AI, and Warp
- **日期**：2026-04-29
- **分类**：Agents
...
### 52. Product development in the agentic era
- **日期**：2026-04-29
- **分类**：Agents
...
### 53. Onboarding Claude Code like a new developer: Lessons from 17 years of development
- **日期**：2026-04-28
- **分类**：Claude Code
...
### 54. New connectors in Claude for everyday life
- **日期**：2026-04-23
- **分类**：Product
...
### 55. Built-in memory for Claude Managed Agents
- **日期**：2026-04-23
- **分类**：Product
...
### 56. Building agents that reach production systems with MCP
- **日期**：2026-04-22
- **分类**：Agents
...
### 57. Introducing Claude Design by Anthropic Labs
- **日期**：2026-04-17
- **分类**：Product
...
### 58. Redesigning Claude Code on desktop for parallel agents
- **日期**：2026-04-14
- **分类**：Product
...
### 59. Preparing your security program for AI-accelerated offense
- **日期**：2026-04-10
- **分类**：Security
...
### 60. Claude Managed Agents: get to production 10x faster
- **日期**：2026-04-08
- **分类**：Product
...
### 62. Harnessing Claude's intelligence
- **日期**：2026-04-02
- **分类**：Guide
...
### 63. What 81,000 people want from AI
- **日期**：2026-03-18
- **分类**：Research
- **🔗**：[原文](https://www.anthropic.com/news)
...
### 64. Claude now creates interactive charts, diagrams and visualizations
- **日期**：2026-03-12
- **分类**：Product
...
### 66. How enterprises are building AI agents in 2026
- **日期**：2025-12-09
- **分类**：Agents
...
### 67. Improving frontend design through Skills
- **日期**：2025-11-12
- **分类**：Guide
